...
public class ContactsList extends ArrayAdapter<Contact> {
    ...
    private void deleteContact(Contact contact) {
        ...
        db.delete(DBHelper.TABLE_CONTACTS, DBHelper.COLUMN_NAME + " = ? AND " + DBHelper.COLUMN_PHONE + " = ?",
        ...
        // 获取ImageView组件
        ImageView defaultImage = ((Activity) mContext).findViewById(R.id.default_image);
